...
DATASET_NAME='covid-19-death-counts-sex-age-state'
DATASET_ARN='arn:aws:dataexchange:us-east-1:796406704065:data-sets/eb01324e3aff0195f49c686aba1b2f96'
PRODUCT_NAME='Provisional COVID-19 Death Counts by Sex, Age, and State | CDC / NCHS'
PRODUCT_ID='prod-4f4zc6wopsqya'
